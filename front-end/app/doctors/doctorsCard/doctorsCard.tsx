...
export default function DoctorsCard() {
  ...
  return (
    ...
    <div className="w-full bg-slate-50 py-12 px-4">
      <div className="w-full max-w-6xl mx-auto px-4 py-8 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between  select-none">
        ...
        <div className="flex items-center gap-4 pb-2">
          <button
            ...
            className="w-11 h-11 bg-[#007BFF] rounded-[12px] rotate-45 flex items-center justify-center shadow-sm hover:bg-[#0069D9] transition-colors duration-200 focus:outline-none disabled:opacity-40 disabled:cursor-not-allowed"
